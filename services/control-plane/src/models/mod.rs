...
pub struct CreateBotRequest {
    ...
    pub persona: Persona,
    pub asset_focus: AssetFocus,
    #[validate(required_if = "asset_focus == AssetFocus::Custom")]
    pub custom_assets: Option<Vec<String>>,
    pub algorithm_mode: AlgorithmMode,
    pub strictness: Strictness,
    pub risk_caps: RiskCapsInput,
    pub trading_mode: TradingMode,
    pub llm_provider: String,
...
// Sync adapter types (for bot communication)
...
pub struct LlmConfig {
    pub provider: String,
    pub api_key: String, // Decrypted for bot
}
...
pub struct HeartbeatRequest {
    pub status: BotStatus,
    pub timestamp: DateTime<Utc>,
    pub metrics: Option<Vec<MetricPayload>>,
}
